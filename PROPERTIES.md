...
>**Note**: Depending on the method that is used to authenticate with nokia_nsp_network_management, you may not need to set all of the authentication properties.
